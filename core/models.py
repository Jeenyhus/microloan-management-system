...
class LoanApplication(models.Model):
    ...
    interest_rate_requested = models.DecimalField(max_digits=5, decimal_places=2)
    term_in_months_requested = models.IntegerField()
    ...
    def __str__(self):
        return f"Loan Application #{self.id} - {self.borrower}"
...
class PaymentSchedule(models.Model):
    ...
    def __str__(self):
        return f"Payment Schedule for Loan #{self.loan.id} - Due {self.due_date}"